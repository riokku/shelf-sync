...
--
-- supplier_name/supplier_lead_time/order_link/digital_location/
-- applicable_year are placeholder values (fictional suppliers on
-- .example.com — the reserved, non-resolving placeholder domain, same
-- convention the very first dummy-data seed used) rather than left null,
-- matching the hosted org's own data (see git history for the one-off
-- update that filled those in there). expiration_date and barcode are
-- still left null throughout: expiration doesn't meaningfully apply to
...
insert into public.inventory_items (
  ...
  supplier_name, supplier_lead_time, order_link, description,
  ...
  ('11111111-1111-1111-1111-111111111111', 'Chiavari Chairs (Gold)', 'Furniture', 'Warehouse A - Bay 1',
   ...
   'Gatherwell Event Furniture Co.', '5-7 business days', 'https://gatherwell-events.example.com/order/chiavari-chairs-gold',
  ...
  ('11111111-1111-1111-1111-111111111111', 'Chiavari Chairs (White)', 'Furniture', 'Warehouse A - Bay 2',
   ...
   'Gatherwell Event Furniture Co.', '5-7 business days', 'https://gatherwell-events.example.com/order/chiavari-chairs-white',
  ...
  ('11111111-1111-1111-1111-111111111111', 'Folding Chairs (White Resin)', 'Furniture', 'Warehouse A - Bay 3',
   ...
   'Gatherwell Event Furniture Co.', '3-5 business days', 'https://gatherwell-events.example.com/order/folding-chairs-white-resin',
  ...
  ('11111111-1111-1111-1111-111111111111', 'Round Tables (60")', 'Furniture', 'Warehouse A - Bay 4',
   ...
   'Gatherwell Event Furniture Co.', '5-7 business days', 'https://gatherwell-events.example.com/order/round-tables-60in',
  ...
  ('11111111-1111-1111-1111-111111111111', 'Rectangular Banquet Tables (8ft)', 'Furniture', 'Warehouse A - Bay 5',
   ...
   'Gatherwell Event Furniture Co.', '5-7 business days', 'https://gatherwell-events.example.com/order/rectangular-banquet-tables-8ft',
  ...
  ('11111111-1111-1111-1111-111111111111', 'Cocktail Tables (30" High-Top)', 'Furniture', 'Warehouse A - Bay 6',
   ...
   'Gatherwell Event Furniture Co.', '3-5 business days', 'https://gatherwell-events.example.com/order/cocktail-tables-hightop',
  ...
  ('11111111-1111-1111-1111-111111111111', 'Farm Tables (Rustic Wood, 8ft)', 'Furniture', 'Warehouse A - Bay 7',
   ...
   'Gatherwell Event Furniture Co.', '2-3 weeks (custom order)', 'https://gatherwell-events.example.com/order/farm-tables-rustic-wood',
  ...
  ('11111111-1111-1111-1111-111111111111', 'White Tablecloths (120" Round)', 'Linens', 'Warehouse B - Shelf 1',
   ...
   'Linen & Lace Event Textiles', '3-5 business days', 'https://linenandlace.example.com/order/tablecloths-white-120in-round',
  ...
  ('11111111-1111-1111-1111-111111111111', 'Table Runners (Assorted Colors)', 'Linens', 'Warehouse B - Shelf 2',
   ...
   'Linen & Lace Event Textiles', '3-5 business days', 'https://linenandlace.example.com/order/table-runners-assorted',
  ...
  ('11111111-1111-1111-1111-111111111111', 'Chair Sashes (Satin)', 'Linens', 'Warehouse B - Shelf 3',
   ...
   'Linen & Lace Event Textiles', '3-5 business days', 'https://linenandlace.example.com/order/chair-sashes-satin',
  ...
  ('11111111-1111-1111-1111-111111111111', 'Charger Plates (Gold Rim)', 'Tableware & Decor', 'Warehouse B - Shelf 4',
   ...
   'Tablescape Decor Supply', '1-2 weeks', 'https://tablescapedecor.example.com/order/charger-plates-gold-rim',
  ...
  ('11111111-1111-1111-1111-111111111111', 'Centerpiece Vases (Cylinder Glass)', 'Tableware & Decor', 'Warehouse B - Shelf 5',
   ...
   'Tablescape Decor Supply', '1-2 weeks', 'https://tablescapedecor.example.com/order/centerpiece-vases-cylinder-glass',
  ...
  ('11111111-1111-1111-1111-111111111111', 'Cafe String Lights (48ft Strand)', 'Lighting & AV', 'Warehouse C - Rack 1',
   ...
   'BrightStage AV Rentals', '3-5 business days', 'https://brightstage-av.example.com/order/cafe-string-lights-48ft',
  ...
  ('11111111-1111-1111-1111-111111111111', 'LED Uplighting Fixtures', 'Lighting & AV', 'Warehouse C - Rack 2',
   ...
   'BrightStage AV Rentals', '3-5 business days', 'https://brightstage-av.example.com/order/led-uplighting-fixtures',
  ...
  ('11111111-1111-1111-1111-111111111111', 'Wireless PA Speaker System', 'Lighting & AV', 'Warehouse C - Rack 3',
   ...
   'BrightStage AV Rentals', '1-2 weeks', 'https://brightstage-av.example.com/order/wireless-pa-speaker-system',
  ...
  ('11111111-1111-1111-1111-111111111111', 'Wireless Microphone Set', 'Lighting & AV', 'Warehouse C - Rack 4',
   ...
   'BrightStage AV Rentals', '1-2 weeks', 'https://brightstage-av.example.com/order/wireless-microphone-set',
  ...
  ('11111111-1111-1111-1111-111111111111', '20x20 Frame Tent', 'Tents & Flooring', 'Warehouse D - Tent Yard 1',
   ...
   'Canopy & Deck Structures', '2-3 weeks', 'https://canopyanddeck.example.com/order/20x20-frame-tent',
  ...
  ('11111111-1111-1111-1111-111111111111', 'Interlocking Dance Floor Panels (1ft sq)', 'Tents & Flooring', 'Warehouse D - Tent Yard 2',
   ...
   'Canopy & Deck Structures', '1-2 weeks', 'https://canopyanddeck.example.com/order/dance-floor-panels',
  ...
  ('11111111-1111-1111-1111-111111111111', 'Portable Bar Unit', 'Bar & Power Equipment', 'Warehouse E - Bar Storage',
   ...
   'Summit Power & Bar Rentals', '1-2 weeks', 'https://summitpowerbar.example.com/order/portable-bar-unit',
  ...
  ('11111111-1111-1111-1111-111111111111', 'Quiet Inverter Generator (3500W)', 'Bar & Power Equipment', 'Warehouse E - Power Equipment',
   ...
   'Summit Power & Bar Rentals', '1-2 weeks', 'https://summitpowerbar.example.com/order/inverter-generator-3500w',
  ...
  ('11111111-1111-1111-1111-111111111111', 'Incandescent Patio String Lights (Discontinued)', 'Lighting & AV', null,
   ...
   'BrightStage AV Rentals', 'Discontinued — no longer orderable', null,
